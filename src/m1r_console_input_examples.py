...
#      Write your line here: x = int(input('integer goes here:'))
#
#   2. Write a line of code that would input an FLOAT from the console,
#      storing the float in a variable called 'x'.
#      Write your line here: x = float(input('float goes here:'))
#
#   3. Write a line of code that would input a STRING from the console,
#      storing the string in a variable called 'x'.
#      Write your line here: x = input('string goes here:')
#
